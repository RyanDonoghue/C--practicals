...
namespace P1_Calculator
{
    public partial class Form1 : Form
    {
        ...
        public bool num1set = true;
        public string num2 = string.Empty;
        public bool num2set = false;
        public bool errorcheck = false;
        public char operand;
        public decimal result = 0;
        public decimal storedresult = 0;
        public decimal parsed1 = 0;
        public decimal parsed2 = 0;
                ...
                else
                {
                    ...
                    switch (operand)
                    {
                        ...
                        case 'm':
                            parsed1 = Decimal.Parse(num1);
                            parsed2 = Decimal.Parse(num2);
                            result = decimal.Multiply(parsed1, parsed2);
                            displayfield.Text = result.ToString();
                            storedresult = result;
                            previous = true;
                            break;
